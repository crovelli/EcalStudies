...
class ZeeKinematicTools {
   ...
   public:
      ...
      static float cosThetaMCElectrons( HepMC::GenParticle* p1, HepMC::GenParticle* p2 );

      static std::pair<int,float> eleTrackIsolation( const reco::TrackCollection* , const reco::GsfElectron* );
};
#endif
